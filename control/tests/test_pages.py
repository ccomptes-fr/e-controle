...
def access_questionnaire_page(
    client,
    page_name,
    is_control_associated_with_user,
    profile_type,
    is_draft=False,
    assign_questionnaire_editor=True,
):
...
def access_control_page(
    client, page_name, is_control_associated_with_user, profile_type
):
...
def test_can_access_questionnaire_page_if_control_is_associated_with_the_user(client):
    response = access_questionnaire_page(
        client,
...
def test_can_access_to_questionnaire_page_if_questionnaire_is_draft_and_user_is_inspector(
    client,
):
    response = access_questionnaire_page(
        client,
...
def test_no_access_to_questionnaire_page_if_questionnaire_is_draft_and_user_is_not_inspector(
    client,
):
    response = access_questionnaire_page(
        client,
...
def test_can_access_questionnaire_create_page_if_control_is_associated_with_the_inspector_user(
    client,
):
    response = access_control_page(
        client,
...
def test_no_access_questionnaire_create_page_if_control_is_not_associated_with_the_inspector_user(
    client,
):
    response = access_control_page(
        client,
...
def test_can_access_questionnaire_edit_page_if_control_is_associated_with_the_inspector_user_and_user_is_editor(
    client,
):
...
def test_no_access_questionnaire_edit_page_if_control_is_not_associated_with_the_inspector_user(
    client,
):
    response = access_questionnaire_page(
        client,
