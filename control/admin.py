...
class ParentLinksMixin(object):
    ...
    def link_to_theme(self, obj):
        ...
        return format_html('<a href="{}">{}</a>', url, theme)
    ...
    def link_to_questionnaire(self, obj):
        ...
        return format_html('<a href="{}">{}</a>', url, questionnaire)
    ...
    def link_to_control(self, obj):
        ...
        return format_html('<a href="{}">{}</a>', url, control)
...
class ThemeAdmin(OrderedInlineModelAdminMixin, OrderedModelAdmin, ParentLinksMixin):
    ...
    fields = ("id", "title", "questionnaire", "link_to_control")
...
class QuestionAdmin(OrderedInlineModelAdminMixin, OrderedModelAdmin, ParentLinksMixin):
    ...
    fields = ("id", "description", "theme", "link_to_questionnaire", "link_to_control")
...
@method_decorator(staff_member_required, name="dispatch")
class Megacontrol(
    LoginRequiredMixin, QuestionnaireDuplicateMixin, SingleObjectMixin, RedirectView
):
