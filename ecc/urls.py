...
router.register(
    r"questionnaire", control_api_views.QuestionnaireViewSet, basename="questionnaire"
)
...
urlpatterns = [
    ...
    path(
        ...
        control_views.QuestionnaireDetail.as_view(),
        name="questionnaire-detail",
    ),
    path(
        "questionnaire/controle-<int:pk>/creer",
        control_views.QuestionnaireCreate.as_view(),
        name="questionnaire-create",
    ),
    path(
        "questionnaire/modifier/<int:pk>/",
        control_views.QuestionnaireEdit.as_view(),
        name="questionnaire-edit",
    ),
    path(
        "fichier-questionnaire/<int:pk>/",
        control_views.SendQuestionnaireFile.as_view(),
        name="send-questionnaire-file",
    ),
    path(
        "fichier-question/<int:pk>/",
        control_views.SendQuestionFile.as_view(),
    ...
    path(
        "fichier-reponses-deposees/<int:pk>/",
    ...
    path(
        "questionnaire/corbeille/<int:pk>/", control_views.Trash.as_view(), name="trash"
    ),
    path(
        "megacontrole-confirmer/<int:pk>/",
    ...
    path(
        "api/questionnaire/<int:pk>/changer-redacteur/",
...
if settings.DEBUG and settings.ALLOW_DEMO_LOGIN:
    urlpatterns += (
        path(
            "demo-controleur/",
            demo_views.DemoInspectorView.as_view(),
            name="demo-inspector",
        ),
    )
    urlpatterns += (
        path("demo/", demo_views.DemoAuditedView.as_view(), name="demo-audited"),
    )
