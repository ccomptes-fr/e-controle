...
def active_directory_auth(user_email=None):
    ...
    if user_info:
        ...
        raise forms.ValidationError(
            f"Aucun utilisateur trouvé. Vérifiez l'orthographe de l'email renseigné ou assurez-vous que l'équipe de contrôle vous a bien ajouté à un espace de dépôt."
        )
        ...
        try:
            ...
            if conn.bind():
                conn.search(
                    ...
                    attributes=["givenName", "company", "sn", "department", "mail"],
                )
